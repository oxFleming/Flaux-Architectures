              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-1">
                  ...
                  >
                    ...
                    <option value="Standard" className="bg-flaux-dark">Standard</option>
                    <option value="Premium" className="bg-flaux-dark">Premium</option>
                    <option value="Luxury" className="bg-flaux-dark">Luxury / Bespoke</option>
