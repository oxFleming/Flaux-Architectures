...
const services: Service[] = [
  {
    ...
    description: 'From concept to blueprint, we create sustainable structures tailored to the tropical climate of West Africa. Our approach balances aesthetic daring with structural integrity.',
  ...
  },
  {
    ...
    description: 'Curated interiors that blend modern luxury with indigenous art and materials. We source locally to create spaces that feel authentically Nigerian yet globally competitive.',
